...
decisionTreeClassifier = DecisionTreeClassifier(labelCol="indexedLabel", featuresCol="features")

# COMMAND ----------

pipeline = Pipeline(stages=[labelIndexer, featureIndexer1, featureIndexer2, featureAssembler, decisionTreeClassifier])
...
displayHTML("<a href=\"files/tables/vida/kaggle/titanic/outputtest/part-00000-tid-399507271229178987-67847550-d5a1-4e6c-bc79-3db06525dff7-552-c000.csv\">Download Here</a>")
